...
python experiments/step4_attack_non_target.py -d NZTemp -m LSTM -a BIM -s 2210 -e 0.15 -n 1
python experiments/step4_attack_non_target.py -d NZTemp -m LSTM -a BIM -s 2210 -e 0.15 -n 1
python experiments/step4_attack_non_target.py -d NZTemp -m LSTM -a BRNV -s 2210 -e 0.15 -n 5
python experiments/step4_attack_non_target.py -d NZTemp -m LSTM -a BRNV -s 2210 -e 0.15 -n 5
