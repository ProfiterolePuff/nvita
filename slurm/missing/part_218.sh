...
python experiments/step4_attack_non_target.py -d NZTemp -m RF -a NOATTACK -s 2210 -e 0.2 -n 1
python experiments/step4_attack_non_target.py -d NZTemp -m RF -a NOATTACK -s 2210 -e 0.2 -n 1
python experiments/step4_attack_non_target.py -d NZTemp -m RF -a NVITA -s 2210 -e 0.2 -n 1
python experiments/step4_attack_non_target.py -d NZTemp -m RF -a NVITA -s 2210 -e 0.2 -n 1
