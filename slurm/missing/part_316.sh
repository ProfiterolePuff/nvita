...
python experiments/step4_attack_non_target.py -d NZTemp -m LSTM -a NVITA -s 789789 -e 0.15 -n 1
python experiments/step4_attack_non_target.py -d NZTemp -m LSTM -a NVITA -s 789789 -e 0.15 -n 1
python experiments/step4_attack_non_target.py -d NZTemp -m LSTM -a NVITA -s 789789 -e 0.15 -n 3
python experiments/step4_attack_non_target.py -d NZTemp -m LSTM -a NVITA -s 789789 -e 0.15 -n 3
