...
python experiments/step4_attack_non_target.py -d NZTemp -m CNN -a NOATTACK -s 789789 -e 0.2 -n 1
python experiments/step4_attack_non_target.py -d NZTemp -m CNN -a NOATTACK -s 789789 -e 0.2 -n 1
python experiments/step4_attack_non_target.py -d NZTemp -m CNN -a NVITA -s 789789 -e 0.2 -n 1
python experiments/step4_attack_non_target.py -d NZTemp -m CNN -a NVITA -s 789789 -e 0.2 -n 1
