...
python experiments/step4_attack_non_target.py -d NZTemp -m RF -a NVITA -s 58361 -e 0.1 -n 5
python experiments/step4_attack_non_target.py -d NZTemp -m RF -a NVITA -s 58361 -e 0.1 -n 5
python experiments/step4_attack_non_target.py -d NZTemp -m RF -a BRNV -s 58361 -e 0.15 -n 5
python experiments/step4_attack_non_target.py -d NZTemp -m RF -a BRNV -s 58361 -e 0.15 -n 5
