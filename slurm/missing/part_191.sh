...
python experiments/step4_attack_non_target.py -d NZTemp -m CNN -a BRNV -s 2210 -e 0.2 -n 5
python experiments/step4_attack_non_target.py -d NZTemp -m CNN -a BRNV -s 2210 -e 0.2 -n 5
python experiments/step4_attack_non_target.py -d NZTemp -m CNN -a BRS -s 2210 -e 0.2 -n 1
python experiments/step4_attack_non_target.py -d NZTemp -m CNN -a BRS -s 2210 -e 0.2 -n 1
