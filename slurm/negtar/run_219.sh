...
python experiments/step5_attack_target.py -d NZTemp -m CNN -a BRS -s 789789 -e 0.05 -n 1 -t Negative
python experiments/step5_attack_target.py -d NZTemp -m CNN -a BRS -s 789789 -e 0.1 -n 1 -t Negative
