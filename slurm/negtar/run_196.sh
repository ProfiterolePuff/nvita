...
python experiments/step5_attack_target.py -d NZTemp -m CNN -a NVITA -s 58361 -e 0.1 -n 1 -t Negative
python experiments/step5_attack_target.py -d NZTemp -m CNN -a NVITA -s 58361 -e 0.1 -n 3 -t Negative
python experiments/step5_attack_target.py -d NZTemp -m CNN -a NVITA -s 58361 -e 0.1 -n 5 -t Negative
