...
python experiments/step5_attack_target.py -d NZTemp -m LSTM -a BIM -s 1111111 -e 0.05 -n 1 -t Negative
python experiments/step5_attack_target.py -d NZTemp -m LSTM -a BIM -s 1111111 -e 0.1 -n 1 -t Negative
