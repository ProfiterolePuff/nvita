...
python experiments/step5_attack_target.py -d Electricity -m RF -a FULLVITA -s 9999 -e 0.05 -n 1 -t Negative
python experiments/step5_attack_target.py -d Electricity -m RF -a FULLVITA -s 9999 -e 0.1 -n 1 -t Negative
